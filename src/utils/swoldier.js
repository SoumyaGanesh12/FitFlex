...
// repRanges - A range of reps or time per set (used for randomizing)
// ratio - Number of sets → [compoundSets, accessorySets]
// rest - Rest time in seconds → [compoundRest, accessoryRest]
// Compound exercises are movements that: Work multiple joints and multiple muscle groups at once
// Accessory exercises: Target one or two muscles

...
export default function Hero() {
  return (
    ...
    gap-10 items-center justify-center text-center max-w-[900px]
    w-full mx-auto p-4'>
        ...
        <span className='text-blue-400'> mass montrosity </span>, afflicted with severe body dismorphia, unable to fit through doors.
        </p>
